...
%% @doc Yet another JSON (RFC 4627) library for Erlang. mochijson_mq works
...
json_encode_string_unicode([C | Cs], State, Acc) ->
    Acc1 = case C of
               ...
               %% in-line. mochijson_mq does not protect you from this, so
...
encoder_utf8_test() ->
    ...
    Enc = mochijson_mq:encoder([{utf8, true}]),
